...
function task4() {
  function promise1() {
    return new Promise((res, rej) => {
      setTimeout(() => res('Проміс 1 виконано'), 1000)
    })
  }

  function promise2() {
    return new Promise((res, rej) => {
      setTimeout(() => res('Проміс 2 виконано'), 1000)
    })
  }

  Promise.all([promise1(), promise2()]).then((data) => console.log(data)).catch((error) => console.error(error)).finally(() =>console.log("Всі операції завершено"));
