...
function task10() {
  const promise1 = new Promise((res, rej) => setTimeout(() => res("Promise 1"), 500));
  const promise2 = new Promise((res, rej) => setTimeout(() => res("Promise 2"), 200));
  const promise3 = new Promise((res, rej) => setTimeout(() => res("Promise 3"), 300));
